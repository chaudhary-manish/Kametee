...
def upload_to(instance, filename):
    ...
    return f"profile/{now:%Y%m%d%H%M%S}{milliseconds}{extension}"
...
class GroupBiddingEntries(models.Model):
    ...
    MinCyclelossAmount =models.DecimalField(max_digits=8, decimal_places=2,null=True,default=0) 
    BidlossAmount = models.DecimalField(max_digits=8, decimal_places=2,null=True,default=0) 
...
class  AmountRecived(models.Model):   
    ...
    BiddingAmount = models.DecimalField(max_digits=8, decimal_places=2,default=0) 
    MinlossAmount = models.DecimalField(max_digits=8, decimal_places=2,default=0)  
    Cyclenumber =  models.IntegerField(default=0)
